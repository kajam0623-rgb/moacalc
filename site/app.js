...
var TOOLS=[
  ...
  {id:"zodiac",cat:"재미·운세",icon:"",name:"띠·별자리",desc:"생년월일로 확인",render:function(el){
    ...
    function calc(){var d=new Date(el.querySelector("#d").value);if(isNaN(d))return;
      ...
      el.querySelector("#rows").innerHTML=zoCard(tiIdx)+'<div class="li" style="margin-top:14px"><span>띠</span><b>'+ti+'띠</b></div><div class="li"><span>별자리</span><b>'+st+'자리</b></div><div class="li"><span>세는 나이</span><b>'+(new Date().getFullYear()-y+1)+'세</b></div>';}
    el.querySelector("#d").addEventListener("change",calc);calc();}},
