TOOLS.push({id:"saju",cat:"재미·운세",icon:"",name:"사주팔자 만세력",desc:"오행·십성·대운",render:function(el){
    ...
    function go(){
      ...
      var healthBase=cnt[SJ_ES[0]]!==undefined?("오행 중 <b>"+mn+"</b>"+josa(mn,"가/이")+" 가장 약하네. 명리에서 "+mn+josa(mn,"는/은")+" "+WEAK[mn]+"과 이어져 있어. 무리가 쌓이면 거기부터 신호가 오니 평소에 챙겨두게."):"";
      ...
      function duFit(e){
        return e===yEl?"용신 "+yEl+josa(yEl,"와/과")+" 같은 기운이라 <b>순하게 풀리는 구간</b>일세."
          :e===y2El?"보조용신 "+y2El+josa(y2El,"와/과")+" 같은 기운이라 <b>도움이 붙는 구간</b>이야."
          :"용신과는 결이 다른 구간이니 <b>벌이기보다 다지는 때</b>로 삼게.";}
