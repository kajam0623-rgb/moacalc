...
saju:"생년월일과 시각으로 사주팔자를 뽑고 신강·신약 판정, 용신, 재물운·직업운·애정운·건강운, 대운 흐름까지 무료로 풀이합니다. 절기(태양황경) 기반 만세력과 진태양시 보정을 적용한 정통 방식입니다.",
...
saju:["무료 사주","사주팔자","만세력","신강 신약","용신 찾기","오행 분석","십성 대운"],
...
saju:["사주팔자는 태어난 연·월·일·시를 각각 천간+지지 두 글자로 나타낸 여덟 글자입니다.","연주는 입춘, 월주는 절기 기준으로 바뀌며, 이 계산기는 태양황경을 직접 계산해 절기를 판정합니다.","일간(일주의 천간)이 사주의 주인공이며, 나머지 글자와의 관계가 십성입니다.","일간을 돕는 기운의 비율로 신강·신약을 판정합니다. 월지(월령)를 가장 크게, 일지를 그다음으로 가중합니다.","용신은 억부 기준입니다. 신강하면 기운을 덜어내는 오행을, 신약하면 채워주는 오행을 씁니다.","대운은 10년 주기의 큰 흐름으로, 성별과 연간의 음양에 따라 순행·역행이 정해집니다."],
