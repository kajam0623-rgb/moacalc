...
const basic = {
  // 점수 구간은 hub.html namematch 의 BAND 분기(90/75/55/35)와 같아야 한다
  namematch: {
    h2: "점수대별 다섯 가지 유형",
    lead: "마지막 두 자리 점수에 따라 관계의 결을 다섯 가지로 나눠 풀이합니다. 점수가 낮다고 나쁜 짝이라는 뜻은 아닙니다.",
    rows: [
      ["90점 이상","운명형","리듬이 거의 같은 짝. 말하지 않아도 다음 행동이 짐작될 만큼 편하지만, 너무 닮아 새로움이 줄어들 수 있습니다."],
      ["75~89점","안정형","기본 호흡이 잘 맞아 큰 갈등 없이 오래 가는 짝. 무난함에 익숙해져 서로의 변화를 놓치기 쉽습니다."],
      ["55~74점","성장형","처음엔 낯설어도 시간이 갈수록 맞춰지는 짝. 한쪽만 양보한다고 느끼지 않도록 번갈아 맞추는 게 좋습니다."],
      ["35~54점","밀당형","끌리는 힘과 밀어내는 힘이 함께 있는 짝. 지루할 틈이 없는 대신 좋을 때와 나쁠 때의 온도차가 큽니다."],
      ["34점 이하","도전형","결이 완전히 다른 짝. 같은 말을 다르게 알아듣기 쉬워 이해에 시간이 걸리지만 서로 배울 것이 많습니다."],
    ],
  },
  saju: {
    h2: "오행 다섯 가지 뜻",
...
namematch:{
 ...
 해 보면 알게 되는 규칙이 두 가지 있습니다. 첫째, <b>누구 이름을 먼저 쓰느냐에 따라 점수가 달라집니다.</b> 번갈아 놓는 순서가 바뀌면 이웃끼리 더하는 짝이 전부 바뀌기 때문입니다. 김철수와 이영희를 이 순서로 넣으면 18점, 이영희를 먼저 넣으면 3점이 나옵니다. 둘째, <b>성을 넣느냐 빼느냐도 결과를 바꿉니다.</b> 같은 두 사람이 철수와 영희로만 넣으면 47점입니다. 학창 시절에 친구마다 점수가 달랐던 이유가 대개 여기 있습니다. 한 번 정한 방식을 계속 쓰는 편이 비교하기 좋습니다.
